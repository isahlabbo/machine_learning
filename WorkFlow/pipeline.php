...
//In machine learning, it is common to run a sequence of algorithms to process and learn from dataset. 
...
/*
PHP-ML represents such a workflow as a Pipeline, 
which consists sequence of transformers and a estimator.
*/
...
/*
example First our pipeline replace missing value, 
then normalize samples and finally train SVC estimator. 
